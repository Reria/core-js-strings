...
function removeFirstOccurrences(str, value) {
  if (typeof str === 'string' && typeof value === 'string') {
    ...
    if (index !== -1) {
      // If the substring is found, concatenate the two parts of the string without the substring
...
function removeLastOccurrences(str, value) {
  ...
  return str; // Return the input unchanged for invalid input.
}
